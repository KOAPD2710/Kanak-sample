...
function HomePartner(props) {
    ...
    useEffect(() => {
        ...
        let dis = q('.home-part-line-wrap').clientWidth - (offsetMargin * 2) - parseFloat(window.getComputedStyle(q('.home-part-line-wrap')).paddingLeft)
        scroll(({y}) => {
        ...
        function activeIcon(idx) {
            if (!listIcon[idx].classList.contains('done')) {
                ...
                animate(listIcon[idx], { opacity: 1, scale: 1 }, {duration: .3})
            }
        }
                ...
                <div className="container bg-light">
                    <div className="home-part-inner">
                        <div className="home-part-line-wrap">
                            <div className="img img-h home-part-line-main" style={{'--prog': 0, '--totalL': 0}}>
