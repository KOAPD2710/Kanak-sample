...
function PolicyMain() {
    ...
    function Test() {
        useEffect(() => {
            ...
            document.getElementById('termly-embed').appendChild(script);
            ...
            script.onerror = () => {
                console.error('Error loading Termly script.');
            };

            return () => {
                // Cleanup the script when the component is unmounted
                document.getElementById('termly-embed').removeChild(script);
            };
        }, []);

        return (
            <div className="termly-embed" name="termly-embed" id="termly-embed" data-id="6ad1ecb9-f275-4e4c-8771-1e2c84e0c306" data-type="iframe"></div>
        );
    }

    function changeToc() {
        let h2Txt = []
        document.querySelectorAll('.policy-body-main-richtxt h2').forEach((el, idx) => {
            console.log(el);
            el.setAttribute('data-scrollTo', ``)
        })
    }
    useEffect(() => {
        changeToc()
