        ...
        <>
            <div className={`resource-cate-main-grid ${limit >= allItem.length ? 'all-loaded' : ''}`}>
                {allItem.map((item, idx) => (
                    idx < limit ? <>
                        <a href="#" className={`resource-cate-main-item ${idx == "0" ? "first-item" : ""}`} key={idx}>
                            ...
                            <div className="resource-cate-main-item-content">
                                <div className="txt txt-20 txt-bold resource-cate-main-item-content-cate">{item.category}</div>
                                <h4 className="heading h5 txt-black txt-up resource-cate-main-item-content-title">{item.title}</h4>
                                <div className="txt txt-18 txt-med resource-cate-main-item-content-des">{item.content}</div>
                                <span className="txt txt-18 txt-med resource-cate-main-item-content-date">{item.date}</span>
                            </div>
