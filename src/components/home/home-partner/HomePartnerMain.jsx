...
import './HomePartnerMain.scss';
import partIc1 from '../../../assets/part-ic-1.svg';
import partIc2 from '../../../assets/part-ic-2.svg';
import partIc3 from '../../../assets/part-ic-3.svg';
import partIc4 from '../../../assets/part-ic-4.svg';
import partIc5 from '../../../assets/part-ic-5.svg';

function HomePartnerMain({...props}) {
    useGSAP(() => {
    ...
    return (
        <section className="home-part">
            <div className="home-part-stick bg-light">
                        ...
                        <div className="home-part-line-wrap">
                            <div className="img img-h home-part-line-main">
                                <svg height="100%" viewBox="0 0 6199 1375" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M804.137 0V1025.5C804.137 1516.5 426.137 960.5 1011.14 1208.5C1172.7 1276.99 1157.75 937.898 1302.14 926.5C1454.14 914.5 1538.14 1054.5 1613.14 981.5C1688.14 908.5 1520.14 599.5 1681.14 534.5C1820.74 478.142 1869.14 664.5 2063.14 709.5C2257.14 754.5 2481.14 743.5 2623.14 786.5C2765.14 829.5 2777.34 686.352 2834.14 567.846C2905.14 419.715 3094.14 485.448 3083.14 620.618C3072.14 755.788 2998.64 1067.24 3150.14 1129.82C3324.14 1201.7 3300.14 966.876 3553.14 966.876H3862M3862.14 967.412C4117.14 967.412 4110.14 749.5 4246.14 801.5C4443.96 877.136 4359.14 1107.5 4439.32 1151.49C4564.8 1220.33 4503.65 869.294 4684.14 822.5C4765.14 801.5 4851.14 881.5 4941.14 801.5C5031.14 721.5 5008.14 585.5 5240.14 585.5" stroke="#3D3D3D" stroke-width=".4rem"/>
                                </svg>
                            </div>
...
export default HomePartnerMain;